...
export function Card({imgUrl,title,dishDescription}){
    ...
    const iconColor = favorite ? '#FF0000' : '#fffff'

return(
<Container>
    <div id="icon" onClick={alternarIcone}><svg width="26" height="24" viewBox="0 0 26 24" fill={iconColor} xmlns="http://www.w3.org/2000/svg">
    ...
    <div id="img">
        <img src={imgUrl} alt="" />
            ...
            <section>
                <ButtonCount/>
                <Button id="btnConfirm" title="incluir"/>
            </section>
